                        ...
                        <div class="card">
                            <div class="row">
                                ...
                                <li class="breadcrumb-item-active">
                                    <i class="ti-plus"></i> <b> View Hospital Test </b>
                                </li>
                            </div>
                            <h4 align="center"><p style="color: green" align="">
                                Please Kindly Fill The Below Form To Add Hospital Test</p>
                            </h4>
                            ...
                            <div class="card-body">
                                <div class="basic-elements">
                                    <form action="process-add-hospital-test.php" method="post" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label>Test Name</label>
                                                    <input type="text" class="form-control" placeholder="Enter The Test Name" name="test_name" required>
                                                </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="number" placeholder="Enter The Cost of The Test" name="test_amount" required>
                                                </div>
                                                <span style="color: red">** This Field is Required **</span>
                                            </div>

                                            <div class="col-lg-12" align="center">
                                                <button type="submit" class="btn btn-success" name="add-test">Add Test To The Hospital Test List</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
