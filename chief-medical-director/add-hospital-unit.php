                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-elements">
                                    <form action="process-add-hospital-unit.php" method="post" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label>Unit/Department Name</label>
                                                    <input type="text" class="form-control" placeholder="Enter The Unit/Department Name" name="unit_name" required>
                                                </div>
                                                <span style="color: red">** This Field is Required **</span>
                                            </div>
                                           
                                            <div class="col-lg-12" align="center">
                                                <button type="submit" class="btn btn-success" name="add-ward">Add Unit To The Hospital Unit(Department) List</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
