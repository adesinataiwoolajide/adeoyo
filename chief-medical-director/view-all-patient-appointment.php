                ...
                <div class="container-fluid">
                    <section id="main-content">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <p style="color: red" align="center">The Patient Appointment List is Empty</p>
                                </div>
                            </div
                        </div>
                    </div>
                                            ...
                                            <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                                <p>
                                                    <li class="breadcrumb-item">
                                                        <a href="view-all-patient-appointment.php">
                                                            <i class="ti-list"></i> <b> View All Patient Appointments </b>
                                                        </a>
                                                    </li>
                                                ...
                                                <h4 align="center" style="color: green"><p style="color: green" align="">
                                                    <?php echo $hospital_name ?> PATIENT APPOINTMENT</p>
                                                </h4>
                                                <?php
