                                                ...
                                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                                    ...
                                                    <tbody><?php 
                                                        ...
                                                        while($see_case_note=$view_case_note->fetch()){
                                                            ...
                                                            <tr>
                                                                <td><?php echo $y; ?>
                                                                    <a href="edit-patient-casenote.php?card_number=<?php echo $card_number ?>&&casenote_identification=<?php echo $case_note_id ?>" class="btn btn-success" title="More Details" onclick="return(confirmToEdit());">
