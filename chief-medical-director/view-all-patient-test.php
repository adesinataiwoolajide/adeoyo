                ...
                <div class="container-fluid">
                    <section id="main-content">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <p style="color: red" align="center"><?php echo $staff_name ?> Your Patient Test List is Empty, Please Click On<a href="recommend-test.php" class=" btn btn-success"> This Button To Recommend Test For Patient</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
