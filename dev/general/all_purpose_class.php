	...
	class all_purpose{
		...
		public function userAccessLevel($access, $action, $email){
			if($access ==1){
				...
				$_SESSION['success'] = $_SESSION['name']. " ". "Welcome to Adeoyo Hospital ICT Department Dashboard";
				$this->redirect("ict-department/./");
			}elseif($access ==2){
				$nn= $this->operationHistory($action, $email);
				$_SESSION['success'] = $_SESSION['name']. " ". "Welcome to Adeoyo Hospital Dashboard";
				$this->redirect("chief-medical-director/./");
			}elseif($access ==3){
				$nn= $this->operationHistory($action, $email);
				$_SESSION['success'] = $_SESSION['name']. " ". "Welcome to Adeoyo Hospital Doctor's Dashboard";
				$this->redirect("doctor/./");
			}elseif($access ==4){
				$nn= $this->operationHistory($action, $email);
				$_SESSION['success'] = $_SESSION['name']. " ". "Welcome to Adeoyo Hospital Pharmacy Dashboard";
				$this->redirect("pharmacy/./");
			}elseif($access ==5){
				$nn= $this->operationHistory($action, $email);
				$_SESSION['success'] = $_SESSION['name']. " ". "Welcome to Adeoyo Hospital Matron Dashboard";
				$this->redirect("matron/./");
			}elseif($access ==6){
				$nn= $this->operationHistory($action, $email);
				$_SESSION['success'] = $_SESSION['name']. " ". "Welcome to Adeoyo Hospital Pharmacist Dashboard";
				$this->redirect("pharmacist/./");
			}elseif($access ==7){
				$nn= $this->operationHistory($action, $email);
				$_SESSION['success'] = $_SESSION['name']. " ". "Welcome to Adeoyo Hospital Nurse Dashboard";
				$this->redirect("nurse/./");
			}elseif($access ==8){
				$nn= $this->operationHistory($action, $email);
				$_SESSION['success'] = $_SESSION['name']. " ". "Welcome to Adeoyo Hospital Health Assistant Dashboard";
				$this->redirect("health-assistant/./");
			}elseif($access ==9){
				$nn= $this->operationHistory($action, $email);
				$_SESSION['success'] = $_SESSION['name']. " ". "Welcome to Adeoyo Hospital Account Department Dashboard";
				$this->redirect("account-department/./");
			}else{
