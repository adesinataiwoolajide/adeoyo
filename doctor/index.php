    ...
    <div class="container-fluid">
            ...
            <div class="col-lg-8 p-r-0 title-margin-right">
                <div class="page-header">
                    <div class="page-title">
                        <h1>Hello, <?php echo $_SESSION['name']; ?> Welcome To The Doctor's Admin Panel
                        </h1>
                    </div>
                </div>
            </div>
        ...
        <section id="main-content">
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="card" onclick="location.href='view-patients-test.php';">
                        <div align="center">
                            <img src="../icons/test.png" style="width: 100px; height: 100px;" align="center">                    
                            <p align="center">Patient Test</p>
                        </div>         
                    </div>                            
                </div>
                <div class="col-md-3">
                    <div class="card" onclick="location.href='';">
                        <div align="center">
                            ...
                            <p align="center">Recommend Drugs</p>
                        </div>         
                    </div>                            
                </div>
                
                <div class="col-lg-3">
                    <div class="card" onclick="location.href='view-patient-case-note.php';">
                        <div align="center">
                            <img src="../icons/appointment.png" style="width: 100px; height: 100px;" align="center">                    
                            <p align="center">Case Note</p>
                        </div>         
                    </div>                            
                </div>
                <div class="col-lg-3">
                    <div class="card" onclick="location.href='view-patient-appointment.php';">
                        <div align="center">
                            <img src="../icons/appointment.png" style="width: 100px; height: 100px;" align="center">                    
                            <p align="center">My Patient Appointment</p>
                        </div>         
                    </div>                            
                </div>
                ...
                <div class="col-lg-3">
                    <div class="card" onclick="location.href='';">
                        <div align="center">
                            ...
                            <p align="center">My Admitted Patients</p>
                        </div>         
                    </div>                            
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <div class="card" onclick="location.href='';">
                        <div align="center">
                            ...
                            <p align="center">Medical Report</p>
                        </div>         
                    </div>                            
                </div>
