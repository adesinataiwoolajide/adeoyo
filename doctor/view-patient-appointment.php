<?php
    ...
    $view_appointment = $db->prepare("SELECT * FROM patient_appointment WHERE staff_number=:staff_number ORDER BY appointment_id DESC");
                                        ...
                                        <div class="table-responsive">
                                            <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                                ...
                                                <h4 align="center" style="color: green"><p style="color: green" align="">
                                                    <?php echo $hospital_name ?> AVAILABLE APPOINTMEMT</p>
                                                </h4>
                                                <?php
