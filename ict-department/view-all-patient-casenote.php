                                            ...
                                            <div class="table-responsive">
                                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                                    <p>
                                                     ...
                                                     <h4 align="center" style="color: green"><p style="color: green" align=""><?php echo $hospital_name ?> PATIENT CASENOTE</p></p>
                                                    </h4>
                                                    ...
                                                    <tbody><?php 
                                                        ...
                                                        while($see_case_note=$view_case_note->fetch()){
                                                            ...
                                                            <tr>
                                                                <td><?php echo $y; ?>
                                                                    <a href="patient_case_note.php?card_number=<?php echo $card_number ?>&&casenote_identification=<?php echo $case_note_id ?>" class="btn btn-success" title="More Details" onclick="return(confirmToEdiddt());">
